...
export const en: Messages = {
  ...
  home: {
    ...
    routineStreak: 'Scan streak',
    dayStreak: 'day streak',
    scannedToday: 'Today’s scan is in — keep the streak alive tomorrow.',
    noScanToday: 'No scan yet today. Take one to add a day to your streak.',
    ...
    scanDoneToday: 'Today’s scan is done',
  },
  scan: {
    title: 'Skin Scan',
    ...
    alreadyScannedTitle: 'Already scanned today',
    alreadyScannedHint: 'one scan per day',
    alreadyScannedBody: 'You’ve already captured today’s scan. Come back tomorrow for the next one — or log your routine now.',
    scoredNote:
  ...
  routine: {
    ...
    now: 'now',
    notYet: 'not yet',
    bothDoneAdherence: 'Both routines submitted today. 🔥',
    submitBoth: 'Submit both your AM and PM routine to track today’s adherence.',
    streakHint: 'Your streak counts scan days, not routine check-ins — see Home.',
    morning: 'Morning',
    evening: 'Evening',
    submitted: 'submitted ✓',
  ...
  routineBuilder: {
    ...
    onboardSubtitle:
      'Add the steps you actually do each morning and night. You can edit this anytime.',
    editTitle: 'Edit your routine',
    editSubtitle: 'Add, rename, or remove steps for your AM and PM routine.',
    morningSteps: 'Morning steps',
    eveningSteps: 'Evening steps',
    stepPlaceholder: 'e.g. Gentle cleanser',
    addStep: 'Add step',
    remove: 'Remove',
    empty: 'No steps yet — add your first one below.',
    save: 'Save routine',
  ...
  login: {
    title: 'Welcome to Dewpoint',
    subtitle: 'Track your skin against your own past self — never a beauty ideal.',
    email: 'Email',
    ...
    signInTitle: 'Sign in',
    signIn: 'Sign in',
    demoNote: 'Demo sign-in — your account stays on this device, no backend connected yet.',
  },
  onboardingProfile: {
    title: 'A little about you',
    subtitle: 'This helps Dewpoint tailor your first steps — nothing here is shared.',
    genderTitle: 'Gender',
    gender: {
      female: 'Female',
      male: 'Male',
    ...
    hobbyTitle: 'Where are you with skincare?',
    hobbyHint: 'pick one',
    hobby: {
      fixed: {
        title: 'I have a fixed routine and fixed products',
        desc: 'You already know what you use — let’s log it.',
      },
      building: {
        title: 'I’m building a routine and still finding products',
        desc: 'You’re figuring out what works — let’s log what you have so far.',
      },
      new: {
        title: 'I’ve never done skincare before',
        desc: 'Let’s take a first scan to see where you’re starting.',
      },
    },
    continue: 'Continue',
  },
  onboardingProducts: {
    title: 'Log what you use',
    subtitleFixed: 'Add the products already in your fixed routine.',
    subtitleBuilding: 'Add whatever you’re currently using — you can keep building this later.',
    intro: 'Scan a product’s ingredient label, or paste the list below.',
    continue: 'Continue',
    skip: 'Skip for now',
  },
  onboardingFirstScan: {
