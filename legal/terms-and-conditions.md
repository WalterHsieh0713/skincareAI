# Dewpoint — Terms & Conditions

**Effective Date:** June 27, 2026

> **Template notice:** This document is a starting-point template tailored to Dewpoint's feature set. It is **not legal advice.** Have qualified counsel review it before public release — especially the biometric (BIPA), subscription/auto-renewal, limitation-of-liability, and governing-law sections, which are jurisdiction-sensitive.

These Terms & Conditions ("Terms") govern your access to and use of the Dewpoint mobile application and related services (collectively, the "App"). By creating an account or using the App, you agree to these Terms. If you do not agree, do not use the App.
...
## 4. Photos, Facial Images, and Biometric Data
...
Questions about these Terms can be sent to **support@dewpoint.app**.
